...
if __name__=="__main__":
    ...
    #print (pp_dict)
    conn_array, conn_list=get_len_array(unid_gene_map, cdict_un)
    pp_array, pp_list=get_len_array(unid_gene_map, pp_dict_un)
    ...
    ran_array, ran_list=get_len_array(unid_gene_map, ran_dict_un)
    ...
    ran2_array, ran2_list=get_len_array(unid_gene_map, ran2_dict_un)
